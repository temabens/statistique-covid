...
<li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>PUBLICATION</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('post.index')}}">list publication</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>wilaya</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('wilaya.index')}}">list maladie quronique</a></li>
...
<li class="dropdown">
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>source</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('source.index')}}">list source</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>malade</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('malade.index')}}">list pmalade</a></li>
              ...
              <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>profession</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('profession.index')}}">list profession</a></li>
                
              </ul>
            </li>
            </li>
             <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>stati</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('stat.index')}}">list statistique</a></li>
            ...
            <li class="menu-header">COVID-19</li>
            <li class="dropdown">
